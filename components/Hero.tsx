  ...
  return (
    <div className='hero'>
      <div className='flex-1 pt-36 padding-x'>
        <h1 className={`hero__title mb-5 ${poppins.className}`}>Trade horsepower, <br/> not headaches.</h1>
        ...
        <CustomButton
          title='Explore'
          containerStyles='bg-[#0043FF] text-white rounded font-bold transition-all duration-300 ease-in-out hover:bg-blue-600 active:bg-blue-300 mt-10'
